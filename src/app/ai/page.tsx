  ...
  return (
    <section className="px-2 sm:px-[74px] bg-white text-black">
      <div className="container mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-center">
            <div className="lg:col-span-2">
              ...
              <p className="mb-[30px] text-[16px] text-gray-700">
                We develop and integrate APIs that enable your systems, apps, and platforms to <strong>work together seamlessly.</strong>
              </p>
            ...
            <div>
              <Image src="/imageAi.png" alt="API Integration" width={600} height={400} className="object-cover w-full h-auto" />
            </div>
          </div>
        </section>
        ...
        {/* How We Connect Your Systems Section with Custom Stepper */}
