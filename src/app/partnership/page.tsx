              ...
              <div className="grid sm:grid-cols-5 grid-cols-1 gap-4 sm:gap-8 items-center">
                ...
                <div className="relative text-center">
                  <div className="mb-1 -mt-[125px] h-[120px]">
                    <div className="text-[#1B9AAA] font-semibold text-[16px] mb-2 h-[48px]">Submit Your Partnership Application</div>
                    <div className="text-[14px] text-gray-700">Tell us about your company and target market.</div>
                  </div>
                ...
                <div className="relative text-center w-[175px]">
                  ...
                  <div>
                    <div className="text-[#1B9AAA] font-semibold text-[16px] mb-2">Partnership Discussion</div>
                    <div className="text-[14px] text-gray-700">Explore the best model for mutual growth.</div>
                  </div>
                </div>
                ...
                <div className="relative text-center">
                  <div className="mb-1 -mt-[125px] h-[120px]">
                    <div className="text-[#1B9AAA] font-semibold text-[16px] mb-2 h-[48px]">Agreement & Onboarding</div>
                    <div className="text-[14px] text-gray-700">Finalize terms and receive training/materials.</div>
                  </div>
                  <div className="w-[26px] h-[26px] bg-[#1B9AAA] text-white rounded-full flex items-center justify-center font-bold text-xs mx-auto relative z-2">
                      3
                    </div>
                ...
                <div className="relative text-center">
                  ...
                  <div>
                    <div className="text-[#1B9AAA] font-semibold text-[16px] mb-2">Go-to-Market</div>
                    <div className="text-[14px] text-gray-700">Start selling, integrating, or implementing IOI&apos;s solutions.</div>
                  </div>
                </div>
                ...
                <div className="relative text-center">
                  <div className="mb-1 -mt-[125px] h-[120px]">
                    <div className="text-[#1B9AAA] font-semibold text-[16px] mb-2 h-[48px]">Ongoing Collaboration</div>
                    <div className="text-[14px] text-gray-700">Continuous support and co-marketing opportunities.</div>
                  </div>
                  <div className="w-[26px] h-[26px] bg-[#1B9AAA] text-white rounded-full flex items-center justify-center font-bold text-xs mx-auto relative z-2">
                      5
                    </div>
                  ...
                  <div className="space-y-8">
                    <div className="flex items-start gap-5">
                      ...
                      <div className="bg-white p-4 rounded-lg border text-center border-gray-200 flex-1">
                        <div className="text-[#1B9AAA] font-semibold text-[16px] mb-2">Submit Your Partnership Application</div>
                        <div className="text-[14px] text-gray-700">Tell us about your company and target market.</div>
                      </div>
                    </div>
                    ...
                    <div className="w-3 h-3 bg-black rounded-full text-center mt-[2.5rem] flex-shrink-0 relative z-2 left-[11px]"></div>
                      <div className="bg-white p-4 rounded-lg border text-center border-gray-200 flex-1">
                        <div className="text-[#1B9AAA] font-semibold text-[16px] mb-2">Agreement & Onboarding</div>
                        <div className="text-[14px] text-gray-700">Finalize terms and receive training/materials.</div>
                      </div>
                    </div>
                    ...
                    <div className="w-3 h-3 bg-black rounded-full text-center mt-[2.5rem] flex-shrink-0 relative z-2 left-[11px]"></div>
                      <div className="bg-white p-4 rounded-lg border text-center border-gray-200 flex-1">
                        <div className="text-[#1B9AAA] font-semibold text-[16px] mb-2">Ongoing Collaboration</div>
                        <div className="text-[14px] text-gray-700">Continuous support and co-marketing opportunities.</div>
                      </div>
                    </div>
                  </div>
